...
import io.qbeast.core.{QbeastCoreTestSpec, index}
import io.qbeast.core.index.NormalizedWeight

/**
 * Tests of NormalizedWeight.
 */
class NormalizedWeightTest extends QbeastCoreTestSpec {
  ...
  it should "support creation from Weight" in {
    index.NormalizedWeight(Weight(1)) shouldBe Weight(1).fraction
  }
