...
trait Keeper {
   ...
   *   the domain revision
   * @param cubeLimit
   *   the maximum (exclusive) number of cubes to be optimized
   * @return
...
trait Optimization {
   ...
   *
   * @param replicatedCubes
   *   the replicated cube identifiers
   */
...
/**
 * Factory for creating Keeper instances. This interface should be implemented and deployed by
