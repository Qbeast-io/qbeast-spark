...
import org.apache.spark.sql.execution.datasources.{OutputWriterFactory, WriteJobStatsTracker}
...
case class WriteTestSpec(numDistinctCubes: Int, spark: SparkSession, tmpDir: String) {
  ...
  val statsTracker: IndexedSeq[WriteJobStatsTracker] = IndexedSeq.empty
